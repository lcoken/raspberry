...
typedef enum {
    ...
    QXWZ_SDK_STATUS_AUTH_NEED_TERMINAL_ACTIVATION = 4012,
    QXWZ_SDK_STATUS_AUTH_ACCOUNT_BEING_PROCESSED = 4012,
    QXWZ_SDK_STATUS_AUTH_ACCOUNT_FORBIDDEN = 4012,
    QXWZ_SDK_STATUS_AUTH_PARTIAL_CAPS_UNAVAILABLE = 4012,
    QXWZ_SDK_STATUS_AUTH_NO_CAPS_AVAILABLE = 4012,
...
/**
 * Represent the SDK uart adapter configuration.
 */
typedef struct
{
    size_t  size;
...
typedef struct
{
    ...
    /**
     * Reserved for future, ignore this field for the timebeing.
     */
    QXWZUartAdaptConf adapter_config;
